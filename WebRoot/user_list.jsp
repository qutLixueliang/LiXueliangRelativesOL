                        ...
                        <form name="formsearch" action="searchUser.do" method="post" >
                            ...
                            <div class="form-group">
                                <div class="input-search">
                                    ...
                                    <input type="text" class="form-control" name="tname" placeholder="输入老师名称" value="" >
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="container-fluid">
                    ...
                    <li class="shown">
                        <div class="widget widget-shadow" >
                            <figure class="widget-header cover">
                                <a href="showUserx.do?id=${n.id }" title="${n.tname }" target='_self'>
                                    <img  src="./upload/${n.img }" alt="${n.tname }"  style='height:300px!important' height="300px;">
                                </a>
                            </figure>
                            <div class="widget-body">
                                ...
                                <div class="widget-body-footer">
                                    <div class="widget-actions pull-right">
                                        <a href="showUserx.do?id=${n.id }" title="${n.tname }">
                ...
                <div>
                    ...
                    <c:if test="${page.page>1}">
		             <a href="newsListFore_hd.do?page=1" >首页</a>
		             <a href="newsListFore_hd.do?page=${page.page-1 }" class="Ahover"> 上一页</a> 
				     ...
				     <a href="newsListFore_hd.do?page=${page.page+1 }" class="Ahover">下一页</a>
					 <a href="newsListFore_hd.do?page=${page.totalPage }">末页</a>
				    </c:if> 
                    </div>
                    </c:if>
                </div>
