        ...
        <div class="kehubh_tj_k">
            ...
            <ul> 
                ...
                <li>
                    ...
                    <div class="right"> 
                        <input type="password" id="txtPwd"  name="pwd"  onblur="return checkpwd2()" value="${user.pwd }" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                ...
                <li>
                    ...
                    <div class="right">
                        <textarea name="note" id="editor_id" style="width:100%;height:400px;"  placeholder="请输入介绍" class="layui-textarea">${user.note}</textarea>
                    </div>
                </li>
                <li>
                    <div class="left"> &nbsp;</div>
