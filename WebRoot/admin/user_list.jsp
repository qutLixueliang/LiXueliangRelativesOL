	...
	<table class="layui-table" lay-filter="mylist" lay-size="lg">
		<thead>
			<tr>
				...
				<th lay-data="{field:'time',align:'center', minWidth:170}">用户名</th>
				<th lay-data="{field:'www',align:'center',minWidth:260}">密码</th>
				<th lay-data="{field:'company',align:'center',minWidth:130}">性别</th>
				...
				<th lay-data="{field:'result',align:'center',minWidth:130}">目前状态</th>
