...
<div class="wangid_conbox">
	...
	<!-- 筛选 --> 
	<form action="newsListSearch_lt.do" method="post" >
	<div class="shuaix">
		...
		<div class="right">
			<input type="text" name="name" placeholder="请输入论坛的名称">
	...
	<table class="layui-table" lay-filter="mylist" lay-size="lg">
		<thead>
			<tr>
				...
				<th lay-data="{field:'yx', align:'center',width:360}">名称</th>
				<th lay-data="{field:'fl',align:'center', minWidth:80}">分类</th>
				<th lay-data="{field:'img',align:'center',minWidth:80}">图片</th>
		...
		<tbody>
		 ...
		 <tr>
			  ...
			  <td><a class="layui-btn layui-btn-xs"   href="doUpdateNews_look.do?id=${u.id }" >查看</a>
...
<script type="text/javascript">
    ...
    function add(){
        ...
        layer.open({
            ...
            // time: 2000, //2秒后自动关闭
            anim: 5,//动画
            content: ['doAddNews.do', 'no'], //iframe的url，no代表不显示滚动条 
        }); 
