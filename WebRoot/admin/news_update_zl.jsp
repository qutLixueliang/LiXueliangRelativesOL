...
<body>
    <div class="wangid_conbox">
        ...
        <div class="kehubh_tj_k">
            <form class="layui-form layui-form-pane" action="updateNews_zl.do" method="post" enctype="multipart/form-data" >
            <ul> 
                <li>
                    <div class="left">指南名：</div>
                    <div class="right"> 
                        <input type="text" name="name" required="required" value="${news.name }" placeholder="请输入指南名" autocomplete="off" class="layui-input">
