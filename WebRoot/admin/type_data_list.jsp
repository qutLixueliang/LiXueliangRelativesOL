...
<div class="wangid_conbox">
	...
	<!-- 筛选 --> 
	<form action="vagueFtypeDataList.do" method="post" >
	<div class="shuaix">
		<div class="right">
			<input type="text" name="name" placeholder="请输入板块名查询">
	...
	<table class="layui-table" lay-filter="mylist" lay-size="lg">
		...
		<tbody>
		 ...
		 <tr>
				...
				<td>${u.name }</td>
			  	<td>
				<a class="layui-btn layui-btn-xs"   href="doUpdateFtypeData.do?id=${u.id }" >修改</a>
				<a class="layui-btn layui-btn-danger layui-btn-xs color2"  onclick="return del(1,1,1)" href="deleteFtypeData.do?id=${u.id }" >删除</a>
				</td>
			</tr>
        </c:forEach> 
		</tbody>  
...
<script type="text/javascript">
    ...
    function add(){
        ...
        layer.open({
            ...
            // time: 2000, //2秒后自动关闭
            anim: 5,//动画
            content: ['type_data_add.jsp', 'no'], //iframe的url，no代表不显示滚动条 
        }); 
