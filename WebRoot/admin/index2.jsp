				...
				<ul class="layui-nav layui-nav-tree"  lay-filter="test">
                    <c:if test="${sessionScope.auser.utype=='管理员'}">
                        ...
                        <li class="layui-nav-item">
                            <a href="javascript:;"><i class="fa fa-sitemap fa-fw"></i>寻亲登记管理</a>
                            <dl class="layui-nav-child">
                                <dd><a href="typeList.do" target="main_self_frame">寻亲分类</a></dd>
                                <dd><a href="goodsList.do" target="main_self_frame">寻亲登记列表</a></dd>
                            </dl>
                        </li>
                        <li class="layui-nav-item">
                        ...
                        <li class="layui-nav-item">
                            <a href="javascript:;"><i class="fa fa-hourglass-half fa-fw"></i>指南管理</a>
                            <dl class="layui-nav-child">
                                <dd><a href="newsList_zl.do" target="main_self_frame">指南管理</a></dd>
                            </dl>
                        </li>
                        <li class="layui-nav-item">
                            <a href="javascript:;"><i class="fa fa-hourglass-half fa-fw"></i>论坛管理</a>
                            <dl class="layui-nav-child">
                                <dd><a href="typeDataList.do" target="main_self_frame">论坛板块列表</a></dd>
                                <dd><a href="newsList_lt.do" target="main_self_frame">论坛管理</a></dd>
                            </dl>
                        </li>
                        <li class="layui-nav-item">
                            <a href="javascript:;"><i class="fa fa-hourglass-half fa-fw"></i>留言管理</a>
                            <dl class="layui-nav-child">
                                <dd><a href="bbsList.do" target="main_self_frame">用户留言管理</a></dd>
                            </dl>
                        </li>
                    </c:if>
                    <c:if test="${sessionScope.auser.utype=='老师'}">
                        ...
                        <li class="layui-nav-item">
                            <a href="javascript:;"><i class="fa fa-hourglass-half fa-fw"></i>论坛管理</a>
                            <dl class="layui-nav-child">
                                <dd><a href="typeDataList.do" target="main_self_frame">寻亲板块列表</a></dd>
                                <dd><a href="newsList_sp.do" target="main_self_frame">论坛管理</a></dd>
                            </dl>
                        </li>
                        <li class="layui-nav-item">
                            <a href="javascript:;"><i class="fa fa-hourglass-half fa-fw"></i>评论管理</a>
                            <dl class="layui-nav-child">
                                <dd><a href="bbsList.do" target="main_self_frame">用户留言管理</a></dd>
                            </dl>
                        </li>
