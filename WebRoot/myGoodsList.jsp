...
%>
    ...
    layui.use('table',function(){
        ...
        <h3 style="  margin-top: 61px;"><a href="doGoodsAdd.do" style="    margin-left: 200px;    margin-top: 61px;">添加寻亲</a></h3>
		 ...
		 <tr>
             ...
             <td>
                 <c:if test="${u.status=='待审核'}">
                     <a class="layui-btn layui-btn-xs"   href="doGoodsUpdate.do?id=${u.id }" >修改</a>
                 </c:if>
                  <a class="layui-btn layui-btn-danger layui-btn-xs color2"  onclick="return del(1,1,1)" href="deleteGoodsFore.do?id=${u.id }" >删除</a>
			  </td>
			</tr>
        </c:forEach> 
		</tbody>  
