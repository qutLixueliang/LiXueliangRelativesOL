       ...
       <table class="layui-table" lay-filter="mylist" lay-size="lg" >
		<thead>
			<tr>
			    ...
			    <th lay-data="{field:'www',align:'center',minWidth:260}">点赞时间</th>
		...
		<tbody style="height: 250px;">
		 ...
		 <tr>
				...
				<a href="showGoodsx.do?id=${n.id }">${n.name }</a></c:if>
				</c:forEach></td>
	          	<td>${u.pubtime }</td>
			  <td><a class="layui-btn layui-btn-danger layui-btn-xs color2"  onclick="return del(1,1,1)" href="deleteKeep.do?id=${u.id }" >删除</a>
			  </td>
			</tr>
        </c:forEach> 
		</tbody>  
