            ...
            <div class="container">
                <div class="row">
                    <div class="product-search">
                        <form name="formsearch" action="searchNews_zl.do" method="post" >
                            ...
                            <div class="form-group">
                                <div class="input-search">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="输入指南名称" value="" >
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="container-fluid">
                    ...
                    <li class="shown">
                        <div class="widget widget-shadow" >
                            <figure class="widget-header cover">
                                <a href="showNewx_zl.do?id=${n.id }" title="${n.name }" target='_self'>
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-body-footer">
                                    <div class="widget-actions pull-right">
                                        <a href="showNewx_zl.do?id=${n.id }" title="${n.name }">
                ...
                <div>
                    ...
                    <c:if test="${page.page>1}">
		             <a href="newsListFore_zl.do?page=1" >首页</a>
		             <a href="newsListFore_zl.do?page=${page.page-1 }" class="Ahover"> 上一页</a> 
				     ...
				     <a href="newsListFore_zl.do?page=${page.page+1 }" class="Ahover">下一页</a>
					 <a href="newsListFore_zl.do?page=${page.totalPage }">末页</a>
				    </c:if> 
                    </div>
                    </c:if>
                </div>
